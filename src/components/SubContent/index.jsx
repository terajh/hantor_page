              ...
              <div className="container_outer">
                <div className="container">
                  <div className="box fw300">
                    학교를 다니는 4년동안, 처음 심은 씨앗이 열매를 맺을 수
                    있도록 위에서 끌고 아래서 쫓아가는 소프트웨어학과의 대표적인
                    학술 소학회로 자리매김하였습니다.
                  </div>
                </div>
              </div>
            ...
            <div className="container">
              ...
              <div className="row">
                <div className="col-sm-6 fw300 mb40-xs">
                  ...
                  <br />
                  학술 소학회 <span className="fw400">HANTOR</span>는 매년 활동
                  재학생 학우 수 약 150명을 자랑하는
                  <br />
