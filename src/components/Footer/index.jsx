    ...
    return (
        <footer className="main_footer">
			<div className="container_outer clearfix text-center">
					...
					<div className="copy eng">Copyright ⓒ 2020 by HANCOMM Inc. All Rights Reserved.<br className="visible-xs"/> Hantor is a <span className="fcBlue">Doosan Corporation</span> company.</div>
			</div>
		</footer>
    )
}
