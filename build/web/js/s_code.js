...
var s_account="ds-w-hancomm-prod"
...
s.linkInternalFilters="javascript:,doosan.com,doosanheavy.com,doosanpowersystems.com,doosanlentjes.com,doosanbabcock.com,doosanhydro.com,doosaninfracore.com,skodapower.com,doosanimgb.com,doosanvinahaiphong.com,doosan-vina.com,doosaninfracore.com,doosan-iv.com,doosanenc.com,doosanengine.com,doosanelectronics.com,doosanmottrol.com,doosanic.com,doosancapital.co.kr,doosandst.com,yonkang.org,doosanfeed.com,oricom.com,rexcon.co.kr,neoplux.co.kr,ladenaresort.com,doota.com,doosanbears.com,familydoo.com,weveapt.co.kr, doosanmachinetools.com,doosansolus.com"
...
function trackClicks(LinkName) {
  s.linkTrackVars="eVar5,events";
  s.linkTrackEvents="event5";
  s.eVar5=LinkName;
  s.events="event5";
  s.tl(true,'o','Link Clicks');
}

function AdobeSocialClicks(SocialName) {
  s.linkTrackVars="events,eVar8,eVar9"; 
  s.linkTrackEvents='event3';
  s.eVar8=SocialName; 
  s.eVar9=s.pageName;
  s.events="event3";
  s.tl(true,'o','Social Content Share');
}
...
function s_doPlugins(s) {
    ...
    /* Break up Page Name into Hireracy level */
		...
		if(valueArray[1]!=undefined) {
			s.prop1=valueArray[1];		// Category depth 1
			if(valueArray[2]!=undefined) {
				s.prop2=valueArray[1]+':'+valueArray[2];		// Category depth 2
				if(valueArray[3]!=undefined) {
					s.prop3=valueArray[1]+':'+valueArray[2]+':'+valueArray[3];	// Category depth 3
					if(valueArray[4]!=undefined) {
						s.prop4=valueArray[1]+':'+valueArray[2]+':'+valueArray[3]+':'+valueArray[4]; 	// Category depth 4
					}
				}
			}
		}
  ...
  if(s.pageName&&!s.hier1) s.hier1=s.pageName;
	...
	/* get Frame Referrer into s.referrer */
   s.referrer=getFrameReferrer();
...
s.visitorNamespace="doosan"
s.trackingServer="doosan.sc.omtrdc.net"
